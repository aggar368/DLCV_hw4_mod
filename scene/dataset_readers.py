...
def fetchPly(path, random_pcd=False):
...
def readColmapSceneInfo(path, images, depths, eval, train_test_exp, llffhold=8, all_eval_path=None, random_pcd=False):
    try:
    ...
    try:
        pcd = fetchPly(ply_path, random_pcd=random_pcd)
    except:
        pcd = None
